...
def new_run(
        ...
        hep_config: DictConfig = None, 
        load_agent_path: str = None, 
        cluster_mode: bool = False,
        wandb_key: str = None,
        project_name: str = 'sb3',
        log_freq: int = 50
        ):
    '''
    ...
    # Initiate env
    env = gym.make(env_name, env_config=env_config, hep_config=hep_config)
    ...
    eval_env = gym.make(env_name, env_config=env_config, hep_config=hep_config)
    eval_env = Monitor(eval_env)
    eval_callback = TensorboardCallback(eval_env, n_eval_episodes=10, eval_freq=log_freq, 
                                        deterministic=True, render=False)
   
    # Evaluation Callback for model saving 
    eval_env_2 = gym.make(env_name, env_config=env_config, hep_config=hep_config)
